...
<img src="resources/img/sunset.JPG" align = "right"alt="Image" height="300" width="300"> <div style="text-align: left"> SCUBA divers surveyed transects for sea cucumbers species. Sea cucumbers were recorded and processed, along with a number of environmental indicators and habitat measurements (Table\@ref(tab:mytable)).
<br><br><br>
...
Initial data anlayses for some of the high and medium value commercial species looked at length frequency profiles (Figure\@ref(fig:plot2)), as well as average density estimates across survey years (Figure\@ref(fig:standard-plot)). 
...
I plan to use ggplot to plot Catch Per Unit Effort data and will look at writing functions to capture other analyses currently run in Excel. I will also be trying _modelr_ for looking at modelling stock trends for species.
