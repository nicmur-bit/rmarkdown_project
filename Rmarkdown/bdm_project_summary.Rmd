...
<img src="resources/img/sunset.JPG" align = "right"alt="Image" height="300" width="300"> <div style="text-align: left"> SCUBA divers surveyed reef top, reef top buffer and reef edge transects for sea cucumbers species. Sea cucumbers were processed and recorded, along with a number of environmental indicators and habitat measurements (Table\@ref(tab:mytable)).
<br><br><br>
